        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 bg-black p-8 border border-military shadow-2xl hidden md:block">
              ...
              <span className="text-xs font-bold uppercase tracking-widest text-white/50">Founded in West Virginia</span>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mt-4">
              <div className="border-l-4 border-military pl-6 py-2">
                <h4 className="font-display font-black uppercase text-xl mb-2">Efficiency First</h4>
                <p className="text-sm text-gray-400">Streamlined workflows that minimize downtime and maximize network rollout speed.</p>
              </div>
              <div className="border-l-4 border-military pl-6 py-2">
                <h4 className="font-display font-black uppercase text-xl mb-2">Rugged Reliable</h4>
                <p className="text-sm text-gray-400">Trained to handle the harshest environments and steep terrain of West Virginia.</p>
              </div>
            </div>
          </div>
        </div>
